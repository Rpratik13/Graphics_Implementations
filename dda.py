...
def setColor():
    if len(colors) == 0:
        ...
        if (colors[-1] == 'r' and colors[0] == 'g') or (colors[0] == 'r' and colors[-1] == 'g'):
            glColor(0, 0, 1, 0)
            colors.append('b')
        elif (colors[-1] == 'r' and colors[0] == 'b') or (colors[0] == 'r' and colors[-1] == 'b'):
            glColor(0, 1, 0, 0)
            colors.append('g')
        elif (colors[-1] == 'b' and colors[0] == 'g') or (colors[0] == 'b' and colors[-1] == 'g'):
            glColor(1, 0, 0, 0)
            colors.append('r')
